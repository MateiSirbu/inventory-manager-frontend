...
Since this app is served over HTTPS, you will need an SSL certificate that includes the public key (`frontend.crt`), and the associated private key (`frontend.key`). Please store them inside `src\ssl\`. If you need help, you can find my tutorial [here](https://github.com/MateiSirbu/generate-ssl-cert-with-san).
